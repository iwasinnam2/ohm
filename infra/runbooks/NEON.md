...
1. **Scale-to-zero** — project `default_endpoint_settings.suspend_timeout_seconds`
   ...
   Compute. Idle mirror traffic does not justify always-on CU.
2. **Leave history at 6h** (Free max) until mirror tables exist and you upgrade.
...
[ ] (Paid) Schedule daily snapshots, retention 7–14d; history window 1d
