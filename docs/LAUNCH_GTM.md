# Launch GTM — steal distribution (not sales)

Traditional outreach is optional icing. Primary engine: **assets people copy**.
...
| 5 | Artifact bounty | [/bounty](https://www.withohm.dev/bounty) — $100 usage credit; email the social post URL that shares your receipt |
...
2. Open 1–2 list PRs from the steal-kit (awesome-mcp / cursor.directory)
3. Attach `fetch.withohm.dev` CNAME when ready
4. Optionally set `OHM_DEMO_API_KEY` on Amplify for live-pipe toy fetches
