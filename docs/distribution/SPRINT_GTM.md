...
| **A — Show HN** | [SHOW_HN_RUNBOOK.md](SHOW_HN_RUNBOOK.md) | Tue–Thu UK · 2h live · one shot · lead with `/demo` |
...
1. **Ship:** waste-check funnel live + `OHM_DEMO_API_KEY` on Amplify
2. **Now → HN day:** fill gap surfaces + start hit list + 5/day outreach (offer = run `/demo`)
3. **HN day:** fire Show HN; pause cold spray; live replies only
4. **After:** same-day keys; day 5–7 quote harvest; resume 5/day
