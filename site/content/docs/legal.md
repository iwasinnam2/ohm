...
Lead harvesting, person dossiers, biometrics, login-gated or credentialed URLs, cold-email / SMS blast list building, cache export for model training.

## Policy API

`GET /v1/compliance/policy` (authenticated) returns the live matrix, excerpt caps, ack requirements, and public document URLs.
